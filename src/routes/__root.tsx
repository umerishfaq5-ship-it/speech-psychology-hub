...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Clinical Center for Speech & Psychology — Human Communication & Mental Health" },
      { name: "description", content: "Evidence-based speech-language pathology and psychology care for children and adults. Book an appointment: 0331 880 7617." },
      { property: "og:title", content: "Clinical Center for Speech & Psychology" },
      { property: "og:description", content: "Human Communication & Mental Health — pediatric and adult speech, language, voice, swallowing, and psychology services." },
